...
from sentinel.feed.rolling_job_schema import DDL as _ROLLING_JOB_DDL
...
from sentinel.feed.action_history_schema import DDL as _ACTION_HISTORY_DDL
DDL.extend(_ACTION_HISTORY_DDL)
