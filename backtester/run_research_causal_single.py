#!/usr/bin/env python3
"""Execute one instrumented retained-research causal-certification replay."""
...
def main() -> int:
    ...
    manifest = {
        "schema": "backtester.research-causal-single-run/1",
        "status": "PASS",
        "view": args.view,
        "cutoff": args.cutoff,
    ...
    print(
        f"[CAUSAL RUN PASS] view={args.view} cutoff={args.cutoff} "
