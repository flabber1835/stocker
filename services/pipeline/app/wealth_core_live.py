...
# The legacy chain stages this branch does NOT require. Named as data so the
# scheduler and its tests read the same list rather than each carrying a copy
# that can drift.
BYPASSED_STAGES: tuple[str, ...] = ("fetch-data", "pipeline", "vet",
                                    "portfolio-builder", "delta")
