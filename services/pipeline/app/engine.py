...
from stock_strategy_shared.drawdown import (
    reentry_blocked as _shared_reentry_blocked)
...
# reentry_blocked is CANONICAL in shared.drawdown (the builder needs the same
# rule; a second copy is how a configured cooldown gets overridden).
reentry_blocked = _shared_reentry_blocked
