...
- [ ] **L01 — Integrate the reviewed fixes and pass required CI.**
  **Now:** INTEGRATION PENDING, #419 and #421 are open.
  **Done when:** both are owner-merged through PRs, any overlap is resolved,
...
- [ ] **L04 — Close command identity and interrupted recovery.**
  **Now:** existing UNKNOWN and recovery acceptance; final compound-case mapping
  pending. Scope F5/F7/F17/F18/C3: executor, journal, recovery, reconciliation,
...
- [ ] **L05 — Close action, identifier and ownership economics.**
  **Now:** rename/rebase/entitlement fixes have retained evidence; final boundary
  cross-check pending. Scope F1/F3/F16 and A14/A15/A16: rolling continuity,
...
- [ ] **L06 — Close rolling-state and restore integrity.**
  **Now:** logical and physical local restore evidence exists; final dependency
  closure against current source pending. Scope F14/F15 and relevant A8/A9/A10/
  A21 dependencies: origin/daily checkpoints, authenticated observations,
...
- [ ] **L07 — Close notifications and process supervision.**
  **Now:** local fixes and takeover/crash tests exist; final cross-component
  ownership review pending. Scope F12/F13 and A1/A6/A17/A18/A19/A24/A25:
...
- [ ] **L08 — Close maintenance, retention and deployment sequencing.**
  **Now:** recurring maintenance is implemented and locally tested; it must not
  be relisted as missing code. Relevant A2/A3/A4/A5/backup-A6/A11/A13/A20/A21/
...
- [ ] **L10 — Publish the final finding-to-evidence reconciliation.**
  **Now:** OPEN documentation/review accounting; this is the missing finite
  closure record, not an additional unbounded source crawl.
  **Done when:** every F1–F19/C1–C3 and relevant #400 finding has a disposition
  ...
  acceptance/falsifier or named external blocker. Reconcile duplicated A5/A6
