...
class ProductionAnnualWorkflowTests(unittest.TestCase):
    ...
    def test_current_main_is_unmodified_production_authority(self):
        self.assertIn("PRODUCTION_MAIN_SHA: c851386fa4dddcf2e2533af3a1d313c38220b7f2", self.worker)
        self.assertIn("ref: c851386fa4dddcf2e2533af3a1d313c38220b7f2", self.worker)
