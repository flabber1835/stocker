...
gc.disable()
ROOT = Path('sharadar')
OUT = Path('/home/runner/work/stocker/stocker/economic-prefix-audit/certified_candidate_types/engine')
    ...
    for y in range(2006,END.year+1):
        ...
        for date,g in d.groupby('date',sort=True):
            ...
            for tid in tids:
                ...
                if q>0 and rawdiv>0: book.receivables.append((gday+15,q*rawdiv)); div_events+=1
