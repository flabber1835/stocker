...
@dataclass
class Book:
    cash:float=100000.0; receivables:list=field(default_factory=list); clean_cash:float=100000.0; clean_receivables:list=field(default_factory=list)
...
def run():
    ...
    rows=[]; overlap_checks={}; buys=sells=split_events=div_events=0; clean_virtual_entries=0; clean_omitted_gross=0.0; clean_affordability_breaches=0; clean_min_cash=100_000.0; clean_micro_min_fraction=1.0; clean_micro_max_fraction=0.0
