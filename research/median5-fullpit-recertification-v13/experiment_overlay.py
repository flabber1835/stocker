#!/usr/bin/env python3
"""Frozen Median-5 canonical overlay for fresh full-PIT recertification."""
from __future__ import annotations

import ast

ARMS = ("MEDIAN5_CANONICAL",)
...
def arm_dimensions(arm: str) -> list[str]:
    if arm != "MEDIAN5_CANONICAL":
        raise ValueError(arm)
    return ["median5", "canonical_frozen", "fresh_fullpit_recertification"]
