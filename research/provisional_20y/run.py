...
START = "2006-07-31"
END = "2026-07-31"
PRODUCTION_REVISION = "daa43caf995779bfa7e67195785520744021cb45"
...
def run(args):
    ...
    dump(args.output / "identity.json", {
        ...
        "source_scenario": "retained-schema-1-base-and-reconstructed-causal-2005-prefix",
