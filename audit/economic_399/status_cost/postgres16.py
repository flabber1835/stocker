...
raise SystemExit(pytest.main(['tests/sentinel/test_status_memory.py','-q','--tb=short',
    '-p','no:cacheprovider','-k','database or exact_json_comparison or cursor_decoder']))
"""
...
sys.argv=['stages.py','storage','--universe','5000']
runpy.run_path('audit/economic_399/status_cost/stages.py',run_name='__main__')
"""
