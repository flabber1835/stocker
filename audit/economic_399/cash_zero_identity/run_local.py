"""Run cash-identity falsifiers in a disposable, network-disabled container."""
import json
...
raise SystemExit(subprocess.run([sys.executable,'audit/economic_399/cash_zero_identity/campaign.py']).returncode)
'''
