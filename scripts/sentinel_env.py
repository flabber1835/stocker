...
# Effective authorized-service defaults from docker-compose.sentinel-automation.yml.
# The host gate runs before Compose; differential tests bind this table to the
# real service environment and runtime validator, including single overrides.
AUTOMATION_INTEGER_DEFAULTS = {
    ...
    "SENTINEL_AUTOMATION_HEARTBEAT_SECONDS": (3, 1),
    "SENTINEL_AUTOMATION_CALLBACK_DEADLINE_SECONDS": (900, 1),
    "SENTINEL_AUTOMATION_CONTROL_POLL_SECONDS": (3, 1),
    "SENTINEL_AUTOMATION_RETRY_BASE_SECONDS": (5, 1),
...
def _validate_semantics(env: Mapping[str, str], *, alert_dispatcher: bool) -> None:
    ...
    deploy_ints = {
        ...
        "SENTINEL_DEPLOY_DATA_WAIT_TIMEOUT_SECONDS": (30, 7200),
