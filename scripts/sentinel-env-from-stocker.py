...
DELIBERATELY_UNSET = {
    ...
    "SENTINEL_VALIDATED_SOURCE_IDENTITY_SHA256":
        "generated by the reviewed validation workflow, never inherited",
    "SENTINEL_VALIDATED_SHADOW_CONFIG_SHA256":
        "generated by the reviewed validation workflow, never inherited",
    "SENTINEL_VALIDATED_DATA_PUBLICATION_SHA256":
        "generated by the reviewed validation workflow, never inherited",
    "SENTINEL_GIT_COMMIT":
        "generated from the reviewed clean checkout, never inherited",
...
def quote(val: str) -> str:
    ...
    Unquoted values containing spaces are legal to compose, fatal to `source`,
    and truncated by anything that strips a whitespace-preceded comment.
    """
