...
def run():
    cases = (
        ...
        ("opening_binary_budget_floor",
         lambda: rounding_checks.test_admitted_dollars_match_canonical_whole_share_boundaries(103283.18, 51.59, 100),
        ...
        ("opening_exact_affordability_uses_float_floor_division",
         ...
         engine, "affordable_whole_shares", rewritten(
             ...
             "return max(0, int(cash // float(per_share)))")),
